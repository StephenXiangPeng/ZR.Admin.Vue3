<template>
	<div>
		...
		<div style="border: 1px solid #e5e7eb; border-radius: 6px; overflow: hidden;">
			...
			<!-- 表格区域 -->
			<el-table class="customer-info-table" :data="ProductSampleTableData"
		...
		<el-dialog :modal="false" modal-penetrable v-model="dialogVisible"
			...
			<el-collapse v-model="sampleInfoCollapseActive" style="margin-bottom: 20px;">
				<el-collapse-item title="样品信息" name="sampleInfo">
					...
					<el-table class="customer-info-table" :data="SampleProductData"
						style="width: 100%;margin-bottom: 15px;" max-height="550" stripe
						:header-cell-style="{ background: '#d1d5db', color: '#333', fontWeight: 'bold' }"
						:row-style="{ height: '20px' }" :cell-style="{ padding: '2px 0' }">
						...
						<el-table-column prop="subproductImage" label="产品图片" width="200" align="center">
							<template #default="scope">
								<el-upload v-paste-image="!isCreateMode && isEditable" :id="`upload-${scope.$index}`" ref="uploadRefs" :auto-upload="false"
